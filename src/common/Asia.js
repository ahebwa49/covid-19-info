...
class Asia extends React.Component {
  ...
  static getDerivedStateFromProps(nextProps, prevState) {
    ...
    const asiaTimeSeries = [];
    for (let i = 0; i < data.length; i++) {
      if (data[i].continent === "Asia") asiaTimeSeries.push(data[i].timeseries);
    }
    const fAsiaTimeSeries = asiaTimeSeries.flat();
    ...
    return (
      <div className="world-line-charts">
        <div className="world-line-chart-confirmed">
          <p style={{ textAlign: "center" }}>Asia Cases</p>
        ...
        <div className="world-line-chart-confirmed">
          <p style={{ textAlign: "center" }}>Asia Deaths</p>
          <svg width={width} height={height}>
            <path
