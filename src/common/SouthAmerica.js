...
class SouthAmerica extends React.Component {
  ...
  static getDerivedStateFromProps(nextProps, prevState) {
    ...
    const southAmericaTimeSeries = [];
    for (let i = 0; i < data.length; i++) {
      if (data[i].continent === "South America")
        southAmericaTimeSeries.push(data[i].timeseries);
    }
    const fSouthAmericaTimeSeries = southAmericaTimeSeries.flat();
    ...
    const nested = d3
      ...
      .entries(fSouthAmericaTimeSeries);
    ...
    return (
      <div className="world-line-charts">
        <div className="world-line-chart-confirmed">
          <p style={{ textAlign: "center" }}>South America Cases</p>
        ...
        <div className="world-line-chart-confirmed">
          <p style={{ textAlign: "center" }}>South America Deaths</p>
          <svg width={width} height={height}>
            <path
