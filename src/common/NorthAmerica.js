...
class NorthAmerica extends React.Component {
  ...
  static getDerivedStateFromProps(nextProps, prevState) {
    ...
    const northAmericaTimeSeries = [];
    for (let i = 0; i < data.length; i++) {
      if (data[i].continent === "North America")
        northAmericaTimeSeries.push(data[i].timeseries);
    }
    const fNorthAmericaTimeSeries = northAmericaTimeSeries.flat();
    ...
    const nested = d3
      ...
      .entries(fNorthAmericaTimeSeries);
    ...
    return (
      <div className="world-line-charts">
        <div className="world-line-chart-confirmed">
          <p style={{ textAlign: "center" }}>North America Cases</p>
        ...
        <div className="world-line-chart-confirmed">
          <p style={{ textAlign: "center" }}>North America Deaths</p>
          <svg width={width} height={height}>
            <path
