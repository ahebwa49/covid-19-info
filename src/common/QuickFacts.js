    ...
    <div className="quick-facts">
      <div className="coming-soon">
        ...
        <p style={{ textAlign: "start" }} className="coming-soon-wording">
          I'm working on making the graphs more interactive by adding a date
          filter in the header. This means that will shall be able to visualize
          pandemic data for a specific date range for example last week, last
          month, last quater, last year, etc.
        </p>
      </div>
